                    ...
                    <div class="card-body">
                        <form action="{{ route('document.update', $document->id) }}" method="post">
                            ...
                            <div class="mb-3 col-12">
                                ...
                                <img src="{{ asset('storage/' . $document->doc_document) }}" alt="{{ $doc->id }}"
                                    name="oldFile" id="oldFile"
                                    class="img-responsive w-25 h-25 opacity-7 img-fluid m-md-2">
                                <input type="file" name="doc_document" id="doc_document"
                                    class="form-control form-control-file" onchange="showPreview(this)">
                                @error('doc_document')
