                    ...
                    <tbody class="text-center">
                        @foreach ($issues as $i)
                            <tr>
                                ...
                                {{--  <td class="d-inline">
                                    ...
                                    <form action="{{ route('issue.destroy', $i->issue_id) }}" method="post"
                                        ...
                                        <button type="submit" onclick="return confirm('are you sure?')"
                                            class="btn btn-danger btn-sm" title="Delete Data"><i class="far fa-trash-alt"></i></button>
                                    </form>
                                </td>  --}}
                                ...
                                <td>
                                    {{-- Show Modal Trigger --}}
                                    <button type="button" onclick="window.location='{{ route('issue.show', $i->issue_id) }}'"
                                    ...
                                    {{-- Edit Modal Trigger --}}
                                    <button type="button" onclick="window.location='{{ route('issue.edit', $i->issue_id) }}'"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form onsubmit="return deleteData('{{ $i->subject }}')"
                                                        method="POST" action="{{ route('issue.destroy', $i->issue_id) }}">
                                                        @csrf
