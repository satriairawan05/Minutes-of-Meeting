...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if ($data)
                <form action="/issue/{{ $data->issue_id }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('issue_xid') is-invalid @enderror" id="issue_xid"
                            name="issue_xid" value="{{ $data->issue_xid }}" readonly />
                        @error('issue_xid')
            ...
            is_invalid
        @enderror" required
                            value="{{ old('project', $data->project) }}" readonly />
                        @error('project')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
            ...
            is_invalid
        @enderror" required
                            value="{{ old('tracker', $data->tracker) }}" readonly />
                        @error('tracker')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
            ...
            is_invalid
        @enderror" required
                            value="{{ old('subject', $data->subject) }}" readonly />
                        @error('subject')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
    ...
    @enderror" readonly />
        ...
        @enderror" required
            ...
            is_invalid
        @enderror" required
                            value="{{ old('priority', $data->priority) }}" readonly />
                        @error('priority')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        @enderror" required
            ...
            is_invalid
        @enderror" required
                            value="{{ old('c_action', $data->c_action) }}" readonly />
                        @error('c_action')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
        ...
        @enderror" required
            ...
            is_invalid
        @enderror" required
                            value="{{ old('assignee', $data->assignee) }}" readonly />
                        @error('assignee')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ asset('storage/' . $data->file) }}" alt="{{ $data->c_action }}" name="oldFile"
                            id="oldFile" class="img-responsive w-25 h-25 opacity-7 img-fluid m-md-2">
                        <input id="file" name="file" type="file"
                            class="form-control form-control-file @error('file')
            is_invalid
        @enderror"
                            value="{{ old('file') }}" onchange="return showPreview(this)" readonly />
                        @error('file')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
