                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="card-widget ">
                                        <label class="main-content-label mb-3 pt-1">MEETINGS HELD</label>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="card-widget">
                                        ...
                                        <h2 class="text-right"><i class="zmdi zmdi-collection-bookmark icon-size float-left text-primary"></i><span class="font-weight-bold">{{$countIssues}}</span></h2>
