            ...
            <div class="inner-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <p class="text-bold">Status : </p>{{ $daily->status }}
                                <p class="text-bold">Subject : </p>{{ $daily->subject }}
                                <p class="text-bold">Corrective Action : </p>{{ $daily->c_action }}
                                <p class="text-bold">Assignee By : </p>{{ $daily->assignee }}
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                @if ($daily->file != null)
                                    <img src="{{ asset('storage/', $daily->file) }}" alt="{{ $daily->subject }}"
                                        id="file" name="file" class="h-100 w-100">
                                @else
