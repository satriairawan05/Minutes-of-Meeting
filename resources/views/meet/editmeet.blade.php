        ...
        <div class="card-body">
            <form method="POST" action="{{ url('meet/'.$txtmid) }}" class="">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-control-sm @error('txtmprepared') is-invalid @enderror" id="txtmprepared" name="txtmprepared" value="{{ $txtmprepared }}">
                        @error('txtmprepared')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control form-control-sm @error('txtmloc') is-invalid @enderror" id="txtmloc" name="txtmloc" value="{{ $txtmloc }}">
                        @error('txtmloc')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
