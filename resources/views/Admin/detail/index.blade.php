      ...
      <table class="table align-items-center mb-0">
        <thead>
          <tr>
            ...
            <th class="text-center text-uppercase text-dark text-xxs font-weight-bolder opacity-7">Tracker</th>
        ...
        <tbody>
          ...
          <tr>
            <td class="text-uppercase text-dark text-xxs font-weight-bolder opacity-4 align-content-center">{{ $loop->iteration }}</td>
            <td class="text-uppercase text-dark text-xxs font-weight-bolder opacity-4 align-content-center">{{ $data->project }}</td>
            <td class="text-uppercase text-dark text-xxs font-weight-bolder opacity-4 align-content-center">{{ $data->tracker }}</td>
            ...
            <td class="text-uppercase text-dark text-xxs font-weight-bolder opacity-4 align-content-center">{{ $data->file }}</td>
            <td>
              ...
              <form action="/resume/{{ $data->id }}" method="post" class="d-inline">
                @method('delete')
                @csrf
                <button href="/resume/{{ $data->id }}" class="btn btn-danger text-sm" type="submit" onclick="return confirm('Are you sure?')">Delete</button>
              </form>
            </td>
          </tr>
          @endforeach
