!(function (e) {
    ...
    15: function (e, a) {
        ...
        $(function () {
            var e,
                a,
                o = document.getElementById("chartLine").getContext("2d"),
                r =
                    (new Chart(o, {
                        type: "line",
                        data: {
                            ...
                            datasets: [
                                ...
                                t(e, "borderWidth", 3),
                                t(e, "pointBackgroundColor", "#ffffff"),
                                t(e, "pointRadius", 2),
                                e),
                            ],
                        },
                    ...
                    (o = document.getElementById("chartBar1").getContext("2d")),
                    new Chart(o, {
                        type: "bar",
                        data: {
                            labels: [
                            ...
                            datasets: [
                                ...
                                t(a, "borderWidth", 2),
                                t(a, "pointBackgroundColor", "#ffffff"),
                                a),
                            ],
                        },
                        options: t(
                    ...
                    (o = document.getElementById("chartBar2")),
                    new Chart(o, {
                        type: "bar",
                        data: {
                            labels: [
                    ...
                    (o = document.getElementById("chartArea")),
                    new Chart(o, {
                        type: "line",
                        data: {
                            labels: [
                ...
                i =
                    (new Chart(l, { type: "doughnut", data: r, options: n }),
                    document.getElementById("chartDonut"));
            new Chart(i, { type: "pie", data: r, options: n }),
                (o = document.getElementById("chartRadar")),
                new Chart(o, {
                    type: "radar",
                    data: {
                        labels: [
                ...
                (o = document.getElementById("chartPolar")),
                new Chart(o, {
                    type: "polarArea",
                    data: {
                        datasets: [
